...
#regex rule5 --> ComPany with random uppercase letter in the middle (no indicator)
Companystring5 = str_extract_all(allfiles, "[a-z]+\\s[A-Z][a-z]+[A-Z][a-z]+\\s[a-z]")
Companystring5[[1]] = str_trim(Companystring5[[1]]) #remove leading space
Companystring5[[1]] = removeWords(Companystring5[[1]], "[a-z]+\\s") #remove first word
Companystring5[[1]] = removeWords(Companystring5[[1]], "\\s[a-z]+") #remove last word
Companystring5[[1]] = unique(Companystring5[[1]])
###### not including because too many false positives ###############
